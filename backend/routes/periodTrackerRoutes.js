...
// Let preflight OPTIONS succeed without auth (avoids CORS 403 on period-tracker)
router.options('*', (req, res) => {
    res.sendStatus(204);
});

// Apply authentication middleware to all routes (OPTIONS already handled above)
